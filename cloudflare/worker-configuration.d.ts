/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ab9e3d0da1a1140fc36ab7bf204ed759)
// Runtime types generated with workerd@1.20260730.1 2026-08-03 nodejs_compat
interface __BaseEnv_Env {
	APP_ORIGIN: "https://app.urbanevents.pk";
	CONTAINER_RUNTIME_BUDGET_HOURS: "400";
	APP_SECRETS_JSON: string;
	URBAN_EVENTS: DurableObjectNamespace<import("./src/index").UrbanEventsContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UrbanEventsContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "CONTAINER_RUNTIME_BUDGET_HOURS" | "APP_SECRETS_JSON">> {}
}
