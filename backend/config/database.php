...
// This logic for parsing the DATABASE_URL is fine for the pgsql connection.
    ...
    */
    ...
    'redis' => [
        ...
        'default' => [
            ...
            // This is the correct way to enable SSL/TLS for Azure Redis
            'scheme' => 'tls',
            // This is critical for preventing queue worker timeouts
        ...
        'cache' => [
            ...
            // Also enable SSL/TLS here
            'scheme' => 'tls',
            // And also add the timeout here
            'read_write_timeout' => -1,
        ],
