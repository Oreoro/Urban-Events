...
export const clientBuildEnv: { [K in ConfigKeys]: string } = {
    ...
    'VITE_AZURE_STORAGE_URL': import.meta.env.VITE_AZURE_STORAGE_URL,
    'VITE_AZURE_STORAGE_CONTAINER': import.meta.env.VITE_AZURE_STORAGE_CONTAINER,
    'VITE_AZURE_STORAGE_SAS_TOKEN': import.meta.env.VITE_AZURE_STORAGE_SAS_TOKEN,
    'VITE_AZURE_STORAGE_PUBLIC_ACCESS': import.meta.env.VITE_AZURE_STORAGE_PUBLIC_ACCESS,
}
